...
<div>
    ...
    <div x-data="postCard" @@click="redirect('{{ route('post.view', $post->slug) }}')"
        class="border-2 relative bg-slate-200 h-[16rem] lg:h-[10rem] cursor-pointer hover:bg-slate-300 bg-center bg-cover"
    ...
    @endif
        <div class="absolute top-0 w-full h-full bg-white/[0.85]">
            <div class="flex flex-col justify-between h-full py-2 px-3">
                <div class="font-semibold text-xl truncate-home-slider-item-title-expanded ">
                    {{ $post->title }}
                </div>
                <div class="text-sm flex justify-between items-end">
                    <div class="flex flex-col pr-2">
                        <div class="flex w-full justify-between gap-2">
                            ...
                            <div>
                                ...
                                <span class="hidden min-[340px]:inline-block">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2">
                        <div class="!bg-gray-400 hover:!bg-gray-500 justify-center text-black inline-flex items-center px-4 py-2 border border-gray-300 rounded-md font-semibold text-xs  uppercase tracking-widest shadow-sm  focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150"
